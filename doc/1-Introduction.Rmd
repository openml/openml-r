...
The R package OpenML is an interface to make interactions with the [OpenML](http://openml.org/) server as comfortable as 
possible. Users can download and upload files, run their implementations on specific [tasks](http://www.openml.org/search?type=task), get
...
the official [OpenML introduction](http://openml.org/guide).
