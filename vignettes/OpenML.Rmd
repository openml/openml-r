...
## Introduction {#intro}
The R package OpenML is an interface to make interactions with the [OpenML](https://openml.org/) server as comfortable as possible.
...
For general information on what OpenML is, please have a look at the [README file](https://github.com/openml/OpenML/blob/master/README.md) or visit the [official OpenML website](https://openml.org/).
...
* `arff.reader`:
    ...
    * `farff`: the [farff package](https://www.github.com/mlr-org/farff) provides a newer, faster parser without any Java requirements
* `confirm.upload`:
...
## Listing {#listing}
In this stage, we want to list basic information about the various [OpenML objects](https://openml.org/guide):
...
You can also have a closer look at the data set on the corresponding OpenML web page (https://openml.org/d/`r subset(datasets, name == "iris" & number.of.classes == 3)$data.id`).
